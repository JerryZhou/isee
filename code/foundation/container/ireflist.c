...
void irefjoint_destructor(const imeta* meta, iptr o) {
    irefjoint *joint = icast(irefjoint, o);
...
void ireflist_destructor(const struct imeta* meta, iptr o) {
    ireflist *list = icast(ireflist, o);
