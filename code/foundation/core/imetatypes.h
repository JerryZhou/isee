...
__ideclaremeta(idictentry,   sizeof(idictentry),0,EnumMetaFlag_Complex,   0, NULL, NULL, idictentry_destructor, idictentry_hash, idictentry_compare, idictentry_assign),\
