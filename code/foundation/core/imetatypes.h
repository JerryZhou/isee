...
__ideclaremeta(ivar,     sizeof(ivar),     0,               EnumMetaFlag_POD,0, NULL, NULL, ivar_destructor, ivar_hash, ivar_compare, ivar_assign),\
...
__ideclaremeta(ikvmemcache,sizeof(ikvmemcache),          0,EnumMetaFlag_Ref,   0, NULL, NULL, ikvmemcache_destructor, NULL, NULL, NULL),\
